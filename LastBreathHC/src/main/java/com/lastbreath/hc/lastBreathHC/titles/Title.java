...
public enum Title {
    ...
    ETERNAL_PARAGON("Eternal Paragon", "Crown", "Hold #1 on the Playtime leaderboard.", TitleCategory.PROGRESSION),
    WARLORD_ASCENDANT("Warlord Ascendant", "Warlord", "Hold #1 on the Player Kills leaderboard.", TitleCategory.COMBAT),
    ABYSSAL_REAPER("Abyssal Reaper", "Abyss", "Hold #1 on the Mobs Killed leaderboard.", TitleCategory.COMBAT),
    PHOENIX_SOVEREIGN("Phoenix Sovereign", "Phoenix", "Hold #1 on the Revives leaderboard.", TitleCategory.PROGRESSION),
    DOOMSPEAKER("Doomspeaker", "DoomSpk", "Hold #1 on the Deaths leaderboard.", TitleCategory.COMBAT),
    DEEPSTONE_TYRANT("Deepstone Tyrant", "Tyrant", "Hold #1 on the Blocks Mined leaderboard.", TitleCategory.PROGRESSION),
    ARCHITECT_PRIMORDIAL("Architect Primordial", "Build", "Hold #1 on the Blocks Placed leaderboard.", TitleCategory.PROGRESSION),
    VEINBREAKER("Veinbreaker", "Vein", "Hold #1 on the Rare Ores Mined leaderboard.", TitleCategory.PROGRESSION),
    VERDANT_MONARCH("Verdant Monarch", "Verdant", "Hold #1 on the Crops Harvested leaderboard.", TitleCategory.PROGRESSION),
    LEVIATHAN_ANGLER("Leviathan Angler", "Levia", "Hold #1 on the Fish Caught leaderboard.", TitleCategory.PROGRESSION),
    STARBORN_OVERLORD("Starborn Overlord", "Overld", "Hold #1 on the Asteroids Looted leaderboard.", TitleCategory.PROGRESSION),
