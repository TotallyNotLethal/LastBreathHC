...
public class TeamCommand implements BasicCommand {
    ...
    public List<String> suggest(CommandSourceStack source, String[] args) {
        if (args.length == 1) {
            return List.of("create", "join", "leave", "kick", "gui");
        }
    ...
    public void execute(CommandSourceStack source, String[] args) {
        ...
        if (args.length < 2 && !"leave".equalsIgnoreCase(args[0]) && !"gui".equalsIgnoreCase(args[0])) {
            player.sendMessage(ChatColor.RED + "Usage: /team <create|join|leave|kick|gui> <name>");
            return;
        }
        ...
        switch (action) {
            ...
            default -> player.sendMessage(ChatColor.RED + "Usage: /team <create|join|leave|kick|gui> <name>");
        }
    }
